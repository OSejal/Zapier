...
export namespace Prisma {
  ...
  */
  ...
  export type TriggerOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "zapId" | "triggerId" | "sortingOrder", ExtArgs["result"]["trigger"]>
  ...
  interface TriggerFieldRefs {
    ...
    readonly sortingOrder: FieldRef<"Trigger", 'Int'>
  }
  ...
  export type TriggerWhereInput = {
    ...
    sortingOrder?: IntFilter<"Trigger"> | number
  ...
  export type TriggerScalarWhereWithAggregatesInput = {
    ...
    sortingOrder?: IntWithAggregatesFilter<"Trigger"> | number
  }
